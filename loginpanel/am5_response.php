...
$where = $sqlTot = $sqlRec = "";
$where .=" WHERE combination_key='WEEKLY_ROUNDUPS' ";
...
while( $row = mysqli_fetch_row($queryRecords) ) { 
  ...
  $a='<a  data-toggle="modal" class="xc-viewedit-btn " xc-character="filesDataLoad" data-target="#editResourceModal" xc-edit="'.$row[0].'">View/Edit</a>  |';
