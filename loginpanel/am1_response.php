...
$sql = "SELECT `id`, `year` , `location`, `start_date`, `end_date`,  `youtube` FROM `summit` ";
...
while( $row = mysqli_fetch_row($queryRecords) ) { 
  ...
  $a='<a  data-toggle="modal" class="xc-viewedit-btn " xc-character="summitDataLoad" data-target="#editSummitModal" xc-edit="'.$row[0].'">View/Edit</a>  |';
  $a.='<a class="xcdelete"  href="./drop.php?id='.$row[0].'&type=summit"> Delete</a>';
