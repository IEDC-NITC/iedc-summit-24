    ...
    <div class="page-content">
      ...
      <div class="card   xc-card-1">
        ...
        <div class="card-body">
          ...
          <table id="dt-manage-am12" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th>Sl.no</th>
                <th>Attachment</th>
...
require_once __DIR__."/am12_create_form.php";
require_once __DIR__."/am12_edit_form.php";
...
<script type="text/javascript">
  $(()=>{
    ...
    datatableResponse('dt-manage-am12','am12_response.php',[{ "width": "2%" },{ "width": "20%" },{ "width": "40%" },{ "width": "20%" }]);
    // mbsd_sane_enter_key('#addDevice');

    ajaxFormSendSpl('#createResource','click','#createResourceInit','./am12_create_init.php','post','#ajaxloader',(res)=>{
      document.querySelector('#createResource').reset();

    });


     $('#dt-manage-am12').on('click','.xc-viewedit-btn',  (e)=>{
    ...
    ajaxFormSendSpl('#editResource','click','#editResourceInit','./am12_edit_init.php','post','#ajaxloader',(res)=>{
