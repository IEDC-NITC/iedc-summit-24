      ...
      <div class="card   xc-card-1">
        <div class="card-header">
          <ul class="nav nav-pills card-header-pills">
            <li class="nav-item"> Daily Editorials
            </li>
        ...
        <div class="card-body">
          ...
          <table id="dt-manage-am6" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th>Sl.no</th>
                <th>Attachment</th>
...
require_once __DIR__."/am6_create_form.php";
require_once __DIR__."/am6_edit_form.php";
...
<script type="text/javascript">
  $(()=>{
    ...
    datatableResponse('dt-manage-am6','am6_response.php',[{ "width": "2%" },{ "width": "20%" },{ "width": "40%" },{ "width": "20%" }]);
    // mbsd_sane_enter_key('#addDevice');

    ajaxFormSendSpl('#createResource','click','#createResourceInit','./am6_create_init.php','post','#ajaxloader',(res)=>{
      document.querySelector('#createResource').reset();

    });


     $('#dt-manage-am6').on('click','.xc-viewedit-btn',  (e)=>{
    ...
    ajaxFormSendSpl('#editResource','click','#editResourceInit','./am6_edit_init.php','post','#ajaxloader',(res)=>{
