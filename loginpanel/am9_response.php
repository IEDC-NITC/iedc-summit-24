...
$where = $sqlTot = $sqlRec = "";
$where .=" WHERE combination_key='NOTIFICATIONS' ";
...
$sql = "SELECT `id`, `title` , `imageurl` FROM `notifications` ";
...
while( $row = mysqli_fetch_row($queryRecords) ) { 
  ...
  $a='<a  data-toggle="modal" class="xc-viewedit-btn " xc-character="notificationsDataLoad" data-target="#editResourceModal" xc-edit="'.$row[0].'">View/Edit</a>  |';
  $a.='<a class="xcdelete"  href="./drop.php?id='.$row[0].'&type=notifications"> Delete</a>';
