      ...
      <div class="card   xc-card-1">
        <div class="card-header">
          <ul class="nav nav-pills card-header-pills">
            <li class="nav-item"> Registration List
            </li>
        ...
        <div class="card-body">
          ...
          <table id="dt-manage-am14" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th>Sl.no</th>
                <th>Name</th>
...
require_once __DIR__."/am14_edit_form.php";
...
<script type="text/javascript">
  $(()=>{
    ...
    datatableResponse('dt-manage-am14','am14_response.php',[{ "width": "2%" },{ "width": "20%" },{ "width": "25%" },{ "width": "25%" },{ "width": "20%" }]);
    


     $('#dt-manage-am14').on('click','.xc-viewedit-btn',  (e)=>{
