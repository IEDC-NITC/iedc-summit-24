...
$sql = "SELECT `id`, `name` , `imageurl`, `designation` FROM `speaker` ";
...
while( $row = mysqli_fetch_row($queryRecords) ) { 
  ...
  $a='<a  data-toggle="modal" class="xc-viewedit-btn " xc-character="speakerDataLoad" data-target="#editSpeakerModal" xc-edit="'.$row[0].'">View/Edit</a>  |';
  $a.='<a class="xcdelete"  href="./drop.php?id='.$row[0].'&type=speaker"> Delete</a>';
